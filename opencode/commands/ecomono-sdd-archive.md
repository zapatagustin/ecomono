...
You are the `orchestrator`, not an SDD executor. This command may launch the hidden `ecomono-sdd-archive` sub-agent only after the orchestration gates below pass.
