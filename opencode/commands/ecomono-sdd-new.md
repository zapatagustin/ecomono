...
1. Launch ecomono-sdd-explore sub-agent to investigate the codebase for this change
2. Present the exploration summary to the user
3. Launch ecomono-sdd-propose sub-agent to create a proposal based on the exploration
