...
ECOMONO-MEMORY NOTE:
Sub-agents handle persistence automatically using the selected artifact store. In ecomono-memory, each phase saves with topic_key "sdd/$ARGUMENTS/{type}" where type is: proposal, spec, design, tasks.
