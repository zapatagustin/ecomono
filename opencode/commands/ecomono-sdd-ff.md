...
1. ecomono-sdd-propose — create the proposal
2. ecomono-sdd-spec — write specifications
3. ecomono-sdd-design — create technical design
4. ecomono-sdd-tasks — break down into implementation tasks
...
ECOMONO-MEMORY NOTE:
Sub-agents handle persistence automatically using the selected artifact store. In ecomono-memory/hybrid, each phase saves with topic_key "sdd/$ARGUMENTS/{type}" where type is: proposal, spec, design, tasks.
