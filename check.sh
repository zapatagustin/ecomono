...
run "shell syntax"                 bash -n install.sh lib/common.sh lib/mcp.sh lib/test-common.sh check-persona-drift.sh check-gate-drift.sh test-gate-drift.sh check-inline-skill-drift.sh check-hook-install-drift.sh test-hook-install-drift.sh
