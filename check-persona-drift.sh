...
# regenerated by tooling, and a reordering is not drift.
#
# ecomono: a set comparison, not a merge. Single-sourcing these is not available
# — the persona block was originally generated by the retired gentle-ai binary and
# has no single source file in this repo. Upgrade path: give it one and
# delete this script.
