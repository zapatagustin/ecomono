...
CAUGHT = {
    ...
    "postgres url": "DATABASE_URL=" + synth("postgres://admin:", "SuperSecretPass123@db.prod.example.com:5432/app"),
    "mysql url": "conn = " + synth("mysql://root:", "hunter2Password@localhost:3306/mydb"),
    "bearer header": "Authorization: " + synth("Bearer ", "abcdefghijklmnopqrstuvwxyz0123456789ABCDEF"),
    "aws session key id": "temp creds " + synth("ASIA", "IOSFODNN7EXAMPLE"),
    "github oauth token": synth("gho_", "016C7869C1AB4B7F5E9A2D3C8F0E1B2A3D4C55"),
    "stripe restricted key": synth("rk_live_", "4eC39HqLyjWDarjtT1zdp7dc"),
    "assigned secret word": "secret = " + synth("a1b2c3d4", "e5f6a7b8c9d0e1f2a3b4"),
    "assigned credential word": "credential: " + synth("z9y8x7w6", "v5u4t3s2r1q0p9o8n7m6"),
...
MISSED_ON_PURPOSE = {
    ...
    "placeholder in angle brackets": "export TOKEN=<your-token-here>",
    "spelled-out placeholder": "export TOKEN=REPLACE_ME_WITH_YOUR_REAL_TOKEN_VALUE",
    "url without a password": "see https://github.com/owner/repo for the write-up",
