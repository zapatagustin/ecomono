...
If the native `ecomono-sdd-verify` sub-agent is available, delegate this command to it.
Otherwise, read the skill file at `~/.claude/skills/ecomono-sdd-verify/SKILL.md` FIRST, then follow its instructions exactly inline.
